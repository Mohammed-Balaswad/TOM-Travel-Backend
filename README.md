ممتاز يا محمد، أضفت خطوة ترحيل المهاجرات (migrations) بشكل منسق داخل دليل الإعداد. إليك النسخة النهائية الجاهزة للإضافة إلى ملف `README.md`:
...
هل تحب أضيف قسم خاص بـ "مشاكل شائعة" أو "ملاحظات للمطورين الجدد"؟ أو ننسق العنوان والغلاف للعرض على GitHub؟
